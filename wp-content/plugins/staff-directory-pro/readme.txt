...
3. This is the Staff Categories screen.
4. This is an example of the Staff List being displayed.
5. This is an example of the Staff Search being displayed.
6. This is the Staff List Widget.
7. This is the Single Staff Widget.
8. This is the Search Staff Widget.
9. This is the Basic Options screen.
10. This is the Import & Export Staff screen.
11. This is the Help & Instructions screen.

== Changelog ==

= 1.7.9 =
* Bugfix: defaults for staff_list shortcode, metadata function

= 1.7.8 =
* Adds Editor Widgets
* Adds Single Staff Member Widget
* Adds Staff Search Widget
* Minor updates
...
= 1.7.6 =
* Fix issue with staff_member shortcode not displaying staff information after update
* Compatible with Wordpress 4.4.2

= 1.7.5 =
* Add support for custom content templates in all contexts (previously only available in single view).
* Minor CSS fixes.
