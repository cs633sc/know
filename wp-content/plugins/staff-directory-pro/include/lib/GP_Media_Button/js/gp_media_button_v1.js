...
function gp_insertWidgetIntoPost()
{
	...
	frm.find(':input').each(function ()
	{
		...
		var always_include = (jQuery(this).data('always-include') == '1');
		...
		else if (jQuery(this).attr('type') == 'hidden' && !always_include ) {
			return true;
		}
		...
		if ( real_name && ( always_include || !gp_value_is_empty(val) ) ) {
