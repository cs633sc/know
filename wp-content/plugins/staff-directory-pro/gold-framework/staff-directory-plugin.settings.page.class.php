...
class StaffDirectoryPlugin_SettingsPage
{
	...
	function settings_page_bottom()
	{
		...
		<div id="signup_wrapper">
			...
			<p class="u_to_p"><a href="http://goldplugins.com/our-plugins/company-directory/upgrade-to-company-directory-pro/?utm_source=themes">Upgrade Now</a> to remove banners like this one.</p>				
		</div>				
		<?php endif; 
	}
	...
	function output_sidebar_coupon_form()
	{
		...
		<div class="topper yellow_orange_bg">
			<h3>Save 10% When You Upgrade To Company Directory Pro</h3>
			<p class="pitch">When you upgrade, you'll instantly unlock the Grid&nbsp;Style, Table&nbsp;Style, Import&nbsp;&amp;&nbsp;Export, Advanced Search, personalized support, and more!</p>
			<a title="Learn More" href="http://goldplugins.com/our-plugins/company-directory-pro/?utm_source=cpn_box&amp;utm_campaign=upgrade&amp;utm_banner=learn_more" class="upgrade_link">Learn More About Company Directory Pro »</a>			
		</div>
		<div id="mc_embed_signup">
			...
			<form action="http://goldplugins.com/atm/atm.php?u=403e206455845b3b4bd0c08dc&amp;id=a70177def0&amp;plug=sdpro" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
				...
				<div class="clear"><input type="submit" value="Send My Coupon Now!" name="subscribe" id="mc-embedded-subscribe" class="smallBlueButton"></div>
				...
				<input type="hidden" id="mc-upgrade-link-per" value="http://goldplugins.com/purchase/company-directory-pro/single?promo=newsub10" />
				<input type="hidden" id="mc-upgrade-link-biz" value="http://goldplugins.com/purchase/company-directory-pro/business?promo=newsub10" />
				<input type="hidden" id="mc-upgrade-link-dev" value="http://goldplugins.com/purchase/company-directory-pro/developer?promo=newsub10" />
