    	...
    	if ($user_can_see_profile):
    		...
    		if ($user):
    			if ($meta != 'wpspro_map'):
                    ...
                    $user_values = array('ID', 'display_name', 'user_login', 'user_nicename', 'user_email', 'user_url', 'user_registered', 'user_status');
	...
	if (is_user_logged_in()) {
		...
		if ($user_can_see_profile):
			...
			if (!isset($_POST['wpspro_password']) || $_POST['wpspro_password'] == ''):
                ...
                $value = get_user_meta( $user_id, 'wpspro_home', true );
                    if ($town && $show_town):
                        ...
                        $form_html .= '<input type="text" id="wpspro_home" name="wpspro_home" value="'.$value.'" />';
                        $form_html .= '</div>';
            ...
            $html .= '<form enctype="multipart/form-data" id="wps_usermeta_change" action="#" method="POST">';
                ...
                $html .= '<input type="submit" id="wps_usermeta_change_submit" class="wps_button '.$class.'" value="'.$label.'" />';
            $html .= '</form>';
