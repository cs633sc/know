...
INSERT INTO `wp_p202s354gc_revisr` VALUES (1,'2016-05-31 00:08:43','Error backing up the database.','error','cs633'),(2,'2016-06-03 04:15:05','Error backing up the database.','error','cs633'),(3,'2016-06-03 05:05:07','Pulled <a href=\"http://know-corp.com/wp-admin/admin.php?page=revisr_view_commit&commit=2b31faa\">#2b31faa</a> from origin/master.','pull','Revisr Bot');
